        ...
        <div class="header_left">
            <div class="header_cont">
             ...
             <a href="../job_seeker/index.php" id="header_le_a">
              ...
              <a href="#" id="header_le_a"><div class="pro_li"><i class="fa fa-file-text" aria-hidden="true"></i><span id="header_manu_name">resume</span></div></a>

              <a href="#" id="header_le_a"><div class="pro_li"><i class="fa fa-bell-o" aria-hidden="true"></i><span id="header_manu_name">Notification</span></div></a>
          ...
          <i class="fa fa-user-circle" aria-hidden="true"></i><span id="header_manu_name">Profile</span></div></a>
            ...
            <div id="pro_manu_list_2">
                 ...
                 <a href="../job_seeker/post-resume.php">


                  <div class="pro_nav_li" >Post Resume</div> </a>
               
                 <a href="#"> <div class="pro_nav_li">Resume Edit</div> </a>
                 <a href="../job_seeker/bookmark-list.php"> <div class="pro_nav_li">Book Marked</div> </a>
