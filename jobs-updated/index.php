  ...
  <body>
		...
		<nav class="navbar navbar-default">
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index-2.html"><img class="img-responsive" src="img/techno1.png" alt="Logo"></a>
				</div>
				<!-- /navbar-header -->
				...
				<div class="navbar-left">
					<div class="collapse navbar-collapse" id="navbar-collapse">
						<ul class="nav navbar-nav">
							...
							<li><a href="job-list.html">Search Jobs</a></li>
							<li><a href="details.html">Employer Area</a></li>
							<li><a href="resume.html">Resume</a></li> 
							<li class="dropdown"><a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown"><img src="img/profile.png" alt="profile"></a>
              ...
              <li class="facebook"><a href="#" target="_blank" data-placement="bottom" title="tutorialspoint @ Facebook">Facebook</a></li>
              <li class="googleplus"><a href="#" target="_blank" data-placement="bottom" title="tutorialspoint @ Google+">Google+</a></li>
              <li class="twitter"><a href="#" target="_blank" data-placement="bottom" title="tutorialspoint @ Twitter">Twitter</a></li>
              <li class="linkedin"><a href="#" target="_blank" data-placement="bottom" title="tutorialspoint @ Linkedin">Linkedin</a></li>
              <li class="youtube"><a href="#" target="_blank" data-placement="bottom" title="tutorialspoint YouTube">YouTube</a></li>
              </ul>
           </div>
				</div>
				<!-- nav-right -->
	...
	<div class="banner-job">
		...
		<div class="container text-center">
			<span class="titl">we are</span>
			<h1 class="title">Workcohol</h1>
			<h3>We connect people and job opportunities</h3>
			<div class="banner-form">
				<form action="#">
					
					<div class="dropdown category-dropdown">	
					<input type="text" class="form-control" placeholder="Type your key word" id="mysea"/>					
						<a data-toggle="dropdown" href="#"><span class="change-text">Job Location</span> <i class="fa fa-angle-down"></i></a>
						<ul class="dropdown-menu category-change" id="search_my">
			...
			<ul class="banner-socail list-inline" id="search_list">
...
<div id="main_box">
		<div style="display: inline-block; padding: 4px; ">
			...
			<div  class="people_layout">
				<div class="people_header"> People you may know</div>
				...
				<div class="people">
					...
					<div class="profile_img"> 
								<div class="profile_area">
									<img src="user.jpg" width="105px" height="105px">
								</div>
					

						<div class="usr_info">
							<div class="name">Arulkumar S</div>
...
<div class="section latest-jobs-ads">
	...
	<script>
	  ...
	  // 	$('#mysea').on('input',function(){
	  // 		search_names();
	  // 	});
			// function search_names(){
			// 	var formdata = {keyword : $('#mysea').val()};
			// 	  		$.ajax({
			...
			// 							//alert('ok');
			// 								  	var usr = JSON.parse(res);
			// 								  	usr = usr.users;
			// 							  	for(b in usr){
			// 							  		var Template = '<li><a href="#">'+usr[b]+'</li>';
			// 							  		document.getElementById("search_my").innerHTML = Template;
			// 							  	  	}
			// 						},error : function(){
			// 							//alert('err');
			// 						}
